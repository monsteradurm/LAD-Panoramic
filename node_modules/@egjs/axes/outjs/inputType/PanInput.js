...
var PanInput = /** @class */ (function () {
    function PanInput(el, options) {
        ...
        this.element = $(el);
        this.options = __assign({ inputType: ["touch", "mouse", "pointer"], scale: [1, 1], thresholdAngle: 45, threshold: 0, iOSEdgeSwipeThreshold: IOS_EDGE_THRESHOLD, hammerManagerOptions: {
